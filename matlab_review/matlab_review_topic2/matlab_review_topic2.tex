...
\item Upon installing of MATLAB you can choose to install simulink. If you did not can can install it through the {\it Add-Ons Explorer} in the home tab. \vspc

\item Open MATLAB and find the command window and start simulink by entering the following. \vspc

\scalebox{1.0}{{\fontfamily{qcr}\selectfont  \hspace{5mm} >>  simulink}} \vspc

\item A Simulink is intended for {\B Model Based Design} \\ $\rightarrow$ a simulink file is called a {\it model} 
