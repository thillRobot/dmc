...
% Dyanmics Review - Topic 5 - Particles and Bodies
%
...
\frametitle{Example of Non-Rigid Body Motion}

 Traditionally engineers build machines that are strong and stiff. These machines are controlled with embedded mechatronics systems or programmable logic controllers. \vspc

 Can you think of a machine or system that relies on non-rigid body motion or systems?
\begin{itemize}
