...
\includegraphics[scale=.15]{Descartes.jpg}
\includegraphics[scale=.2]{cartesian.png}
...
\includegraphics[scale=.2]{polar.png} \hspc
\includegraphics[scale=.3]{cylindrical.png}
...
\includegraphics[scale=.3]{spherical_fig1.png} \hspc
\includegraphics[scale=.2]{spherical_fig2.png}
...
Do of any other systems that are used?
