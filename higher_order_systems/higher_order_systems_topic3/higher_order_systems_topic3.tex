...
\frame{  
  \frametitle{\sectiontitleI}
	...
	Make a substitution for each dependent variable and its first derivative then re-write the system of equations as four first order differential equations. \vspc
	let $ z_1=x_1$ and $z_2=x_2$ \vspc
	also $z_3=\dot{x}_1$ and $z_4=\dot{x}_2$  
