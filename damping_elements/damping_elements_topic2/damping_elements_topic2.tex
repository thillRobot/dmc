...
\end{multicols}
%\begin{framed}
Equation of Motion: \vspc

\scalebox{1}{$m\ddot{x}+kx=0 \hspace{1mm},\hspc x(0)\hspace{1mm} ,\hspc \dot{x}(0)$}  \vspc



Free Response: \vspc
\scalebox{1}{$x(t)=Asin\left(\sqrt{\frac{k}{m}}t\right)+Bcos\left(\sqrt{\frac{k}{m}}t\right)$} \vspc
	...
	\frame{
		...
		\scalebox{1}{$x(t)=Asin\left(\sqrt{\frac{k}{m}}t\right)+Bcos\left(\sqrt{\frac{k}{m}}t\right)$} \vspc
		\includegraphics[scale=.20]{time_axis.png} \vspc
...
\section{\sectiontitleII}
	...
	\frame{
		...
		\scalebox{1}{$x(t)=e^{\alpha t}\left[Asin\left(\sqrt{\frac{k}{m}}t\right)+Bcos\left(\sqrt{\frac{k}{m}}t\right)\right]$} \vspc
		\includegraphics[scale=.20]{time_axis.png} \vspc
	...
	\frame{ 
		\frametitle{\sectiontitleII}
How fast does the system response decay? What is steady state value?
