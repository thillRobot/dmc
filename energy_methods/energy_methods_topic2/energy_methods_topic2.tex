...
\begin{tabular}{lll}
Kinetic Energy & (translation) & \scalebox{1}{$T = \frac{1}{2}mv^2$} \\
&(rotation)& \scalebox{1}{$T = \frac{1}{2}I\omega^2$\hspc } \\
Potential Energy &(gravity)& \scalebox{1}{$V = mgx$} \\
&(spring)& \scalebox{1}{$V = \frac{1}{2}kx^2$} \\
&(electrical)&\scalebox{1}{$V = \kappa Qq/r$} {\tiny (typically per unit charge is used)}
\end{tabular}

\vspace{3mm}
A {\R zero potential} reference is required to properly define the potential energy function, $V(x)$.  
