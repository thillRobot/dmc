...
In the underdamped second order sytem only two regions are present in the Bode diagram. 

\includegraphics[scale=.27]{lecture3_fig4.png}  \includegraphics[scale=.27]{lecture3_fig5.png} 
...
MATLAB has a built in tool for making Bode plots.  
\begin{multicols}{2}
