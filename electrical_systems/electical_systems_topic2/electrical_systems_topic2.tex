...
% Lecture Module - Electrical Systems - Topic 2  - First Order Circuits
...
\newcommand{\topictitle}{First Order Circuits} 

\newcommand{\sectiontitleI}{Example: RC Circuit} % More Titles and Stuff
