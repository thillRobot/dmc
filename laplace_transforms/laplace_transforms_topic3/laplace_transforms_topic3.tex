...
% The Laplace Transform - Module 12 - Topic 3
...
\[ X(s)=\frac{1}{4} \left[ \frac{3s+7}{\left(s+3\right)^2+s^2}\right] \]
...
\[ X(s)=\frac{1}{4}  \left[ C_1 \frac{3s+7}{\left(s+3\right)^2+s^2} +C_2 \frac{3s+7}{\left(s+3\right)^2+s^2}\right] \]
...
\[ X(s)=\frac{1}{4}  \left[\frac{-2}{5}frac{3s+7}{\left(s+3\right)^2+s^2} +3 \frac{3s+7}{\left(s+3\right)^2+s^2}\right] \]
