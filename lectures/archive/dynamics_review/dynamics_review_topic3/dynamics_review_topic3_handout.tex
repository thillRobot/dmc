...
% Lecture Module - Dynamics Review  - Topic 3  - Particle and Bodies 
...
\newcommand{\sectiontitleI}{Particle Motion}
\newcommand{\sectiontitleII}{Rigid Body Motion}
\newcommand{\sectiontitleIII}{Is rigid body motion realistic?}
\newcommand{\sectiontitleIV}{Motion in ME3050}
...
\begin{multicols}{2}
 Traditionally engineers build machines that are ...
