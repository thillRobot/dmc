...
\begin{itemize}
	...
	\item Convervation of Energy Method
\end{itemize}
\vspace{3mm}
The {\B equations of motion} are ordinary differential equations describing the dyanamic relationships between the bodies in the system. One {\B equation of motion} is required for each {\PN DOF}.
}
...
To derive the equations of motion with Netwon's Second Law:
\begin{enumerate}
...
\item If no {\G non-convervative} forces are considered, Convervation of Energy states the change in the {\BR total energy} must equal zero. Take the derivative of {\BR total energy} equation and set it equal to zero. This relation is used to the derive the EOM(s).\vspc
\end{enumerate}
